...
# -*- coding: utf-8 -*-
"""
Created on Fri Jun 26 10:44:36 2020
...
def draw_lines(outside, left, right, simplify):
    # Cria uma matriz vazia para desenhar as linhas
    # simplify = 0 - desenha as linhas brutas
    # simplify = 1 - desenha as linhas simplificadas
...
while(cap.isOpened()):
    ...
    cv2.imshow('frame',canvas_overlay)
